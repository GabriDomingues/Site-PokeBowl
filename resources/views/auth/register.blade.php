        ...
        <div class="col-md-8" >
            <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('store') }}" style="font-family: sans-serif">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-2">
                                ...
                                <input type="number" class="form-content form-control fw-bold" id="adress-number" placeholder="" name="adress_number">
                            </div>
                            <div class="col-3">
