        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #8DC264">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="rounded-circle" alt="avatar1" src="{{ asset('poke_bowl_80x80.jpg') }}" style="border-style: solid; border-width: 2px;"/>
                </a>
    ...
    <div class="container footer-bg">
        <footer class="d-flex flex-wrap justify-content-center align-items-center py-3" style="height: 150px">
            <div class="col-md-4 d-flex align-items-center">
                <span class="mb-3 mb-md-0 text-muted">© 2022 Poke Bowl LTDA</span>
